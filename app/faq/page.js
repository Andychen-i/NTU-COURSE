        ...
        <div className="min-h-screen bg-gradient-to-br from-pink-200 via-purple-200 to-indigo-200">
            <div className="container mx-auto px-4 py-16">
                <div className="text-center">
                    ...
                    <a href="/" className="inline-block mb-12 px-6 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-full hover:from-pink-600 hover:to-purple-600 transition-all">
                        回到首頁
                    </a>
                </div>
                ...
                <div className="max-w-3xl mx-auto">
                    <section className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-8 mb-8 border border-purple-100">
                        <h2 className="text-2xl font-bold text-pink-600 mb-6">合作相關問題</h2>
                    ...
                    {/* 設計服務 */}
                    <section className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-8 mb-8 border border-purple-100">
                        <h2 className="text-2xl font-bold text-pink-600 mb-6">設計服務問題</h2>
                    ...
                    {/* 其他問題 */}
                    <section className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-8 border border-purple-100">
                        <h2 className="text-2xl font-bold text-pink-600 mb-6">其他常見問題</h2>
